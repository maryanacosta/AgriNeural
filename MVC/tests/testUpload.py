...
class TestOperadorController:

    def test_upload_sem_login_simples(self, client): # teste sem sessão ativa
    ...
    def test_upload_nao_operador_simples(self, mock_buscar_por_cpf, client): # teste para verificar que o upload não é acessado por Produtor ou Mosaiqueiro
    ...
    @patch('MVC.model.usuario_dao.UsuarioDAO.buscar_por_cpf')
    def test_upload_sem_arquivos_simples(self, mock_buscar_por_cpf, client): # teste de envio sem imagens
        with client.session_transaction() as sess:
            sess['cpf'] = '12345678900' 
    ...
    @patch('MVC.model.usuario_dao.UsuarioDAO.buscar_por_cpf')
    def test_upload_latitude_invalida_simples(self, mock_buscar_por_cpf, client):
        with client.session_transaction() as sess:
            sess['cpf'] = '12345678900' 
        ...
        test_image_file = "MVC/tests/test_image.jpg" # caminho para uma imagem de teste válida
